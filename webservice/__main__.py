...
async def PR_closed(event, gh, *args, **kwargs):
    ...
    if(event.data["pull_request"]["merged"]== True):
        ...
        await placeFile(str(base64.b64encode(testString.encode("utf-8")),"utf-8"),showcaseRepoTargetURL+"/contents/testfile.txt",0,gh,oauth_token=installation_access_token["token"])
